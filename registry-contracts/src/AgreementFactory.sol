...
contract AgreementFactory {
        ...
        returns (address agreementAddress)
    {
        ...
        Agreement agreement = new Agreement{ salt: finalSalt }(details, registry, owner);
        ...
        returns (address)
    {
        ...
        bytes32 bytecodeHash =
            keccak256(bytes.concat(type(Agreement).creationCode, abi.encode(details, registry, owner)));
